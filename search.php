					...
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
						<div class="right-all-product">
							...
							<div class="product-shooting-area">
								...
								<div id="noidung">
								<?php
								$so1trang=!empty($_GET['per_page'])?$_GET['per_page']:3;//số lượng sản phẩm 1 trang
								$trang=!empty($_GET['page'])?$_GET['page']:1;//trang hiện tại đang đứng
								$from=($trang-1)*$so1trang;
								$ds=mysqli_query($conn,"SELECT *FROM  `product`  LIMIT $from,$so1trang");
									 $total=mysqli_query($conn,"SELECT `id` FROM `product`");
									 $tongsanpham=mysqli_num_rows($total);
									 $sotrang=ceil($tongsanpham/$so1trang);//tổng số trang
															...
															<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
																<div class="single-product-item">
																	<div class="product-image">
																		<a href="single-product.php"><img src="<?php echo $row['images']?>" alt="product-image" /></a>
																	...
																	<div class="product-info">
																		...
																		<a href="single-product.php"><?php echo $row['product']?></a>
																		<div class="price-box">
